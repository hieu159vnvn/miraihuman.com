...
class TinTucController extends Controller
{
    public function index()
    {
        ...
        $tintuc = DB::table('zm_tintucs')->where([['stt','=','1'],['id_loaitintuc','=','1']])->orderBy('id','desc')->paginate(8);
        // $tintucorther = DB::table('zm_tintucs')->where([['stt','=','1'],['id_loaitintuc','=','1']])->skip(1)->take(4)->orderBy('id','desc')->get();
        ...
        $bannerpage = DB::table('zm_bannerpage')->where('page', '=', 'Tin tức')->first();

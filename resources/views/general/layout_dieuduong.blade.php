					...
					<div class="row">
							<div class="col-12">
									<div class="breadcrumbs">
										...
										<a class="breadcrumb__step" href="dieuduong">@lang('messages.layout-dieuduong')</a>
									</div>
							</div>
					</div>
				</div>
			...
			<section class="news">
				<div class="container">
					...
					<div class="row">
						...
						@php
							$tintucorther = DB::table('zm_tintucs')->where([['stt','=','1'],['id_loaitintuc','=','3']])->skip(5)->take(4)->orderBy('id','desc')->get();
						@endphp --}}
						@foreach ($tintuc as $item)
						<div class="col-md-3">
							<div class="sub-news">

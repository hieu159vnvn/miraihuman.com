					...
					<div class="row">
							<div class="col-12">
									<div class="breadcrumbs">
										...
										<a class="breadcrumb__step" href="thuctapsinh">@lang('messages.layout-thuctapsinh')</a>
									</div>
							</div>
					</div>
				</div>
					...
					<div class="row">
						{{-- <div class="col-12">
							<nav class="navbar-center">
								...
								<li><a href="dacdinh">@lang('messages.layout-dacdinh')</a></li>
							</nav>
						</div> --}}
						...
						@php
							$tintucorther = DB::table('zm_tintucs')->where([['stt','=','1'],['id_loaitintuc','=','2']])->skip(5)->take(4)->orderBy('id','desc')->get();
						@endphp --}}
						@foreach ($tintuc as $item)
						<div class="col-md-3">
							<div class="sub-news">
